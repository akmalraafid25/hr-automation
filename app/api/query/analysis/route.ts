  ...
  return new Promise<NextResponse>((resolve) => {
    ...
    connection.connect((err) => {
      ...
      connection.execute({
        ...
        sqlText: "SELECT S.SHORTLIST_ID, A.NAME, A.SKILLS, A.CERTIFICATION, A.WORK_EXPERIENCE, A.EDUCATION, J.JOB_NAME, analysis.ANALYSIS, analysis.PROS, analysis.CONS, analysis.SIMILARITY, A.STATUS FROM SHORTLIST S JOIN APPLICANT A ON S.APPLICANT_ID = A.APPLICANT_ID LEFT JOIN JOB_POST J ON S.JOB_ID = J.JOB_ID LEFT JOIN ANALYSIS analysis ON S.APPLICANT_ID = analysis.APPLICANT_ID;",
